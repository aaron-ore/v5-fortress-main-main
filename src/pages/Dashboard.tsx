...
import { useTutorial } from "@/context/TutorialContext"; // NEW: Import useTutorial
    ...
    <>
      {dashboardView === "classic" ? (
        ...
        <div className="relative"> {/* NEW: Add relative positioning for tutorial targets */}
          ...
          {/* NEW: Tutorial targets for DefaultDashboardContent */}
          {isTutorialActive && currentStep?.id === "total-stock-value-card" && (
