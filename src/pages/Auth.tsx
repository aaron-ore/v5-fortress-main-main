        ...
        <CardContent>
          ...
          <div className="mt-6 space-y-4">
            <Button
              ...
              disabled={loading}
            >
              {/* Updated Google SVG Logo */}
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22.44 12.24c0-.65-.06-1.3-.18-1.95H12.24v3.6h5.83c-.25 1.48-1.08 2.42-2.08 3.16v2.45h3.18c1.85-1.7 2.92-4.08 2.92-6.76z" fill="#4285F4"/>
                <path d="M12.24 23.6c3.24 0 5.93-1.08 7.91-2.96l-3.18-2.45c-.84.6-1.97.96-3.46.96-2.62 0-4.83-1.72-5.67-4.05H3.6v3.23c1.12 2.2 3.3 3.78 6.04 3.78h2.6z" fill="#34A853"/>
                ...
                <path d="M12.24 5.8c1.48 0 2.76.48 3.78 1.3l3.18-2.45c-1.24-1.16-2.88-1.88-4.88-1.88-2.74 0-4.92 1.58-6.04 3.78l2.97 2.62c.84-2.32 3.05-4.04 5.67-4.04z" fill="#EA4335"/>
              </svg>
